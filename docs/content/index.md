...
[HTTP Basic Auth](extensions/basic-auth.md), [API Key](extensions/api-key.md),
[Opaque Token](extensions/opaque-token.md), or [Session](extensions/session.md), or
[implement a fully custom strategy](guides/custom-authentication.md) —
...
[Opaque Token](extensions/opaque-token.md), [Session](extensions/session.md), and
[JWT](extensions/jwt/index.md) supply ready-made strategies; you can also
[write your own](guides/custom-authentication.md).
