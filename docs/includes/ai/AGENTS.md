<!-- Distribution note: drop this file at the root of a consumer repository as AGENTS.md
     so coding agents auto-discover it. -->

# javalin-security — agent reference

Consumer-facing guidance for AI agents adding authentication and authorization to a Javalin 7
